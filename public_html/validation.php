...
if (!isset($_GET['submit'])) {
    ...
    if (empty($_GET['confirmPassword']) || empty($_GET['username'])) {
        $ERROR['confirmPassword'] = "Feild is mandatory";
        $ERROR['username'] = "Feild is mandatory";
    } else if ($_GET['confirmPassword'] != $_GET['username']) {
