...
(1, 'pizza', 'ONION,salt', 'asdadasd', 'iamamarjit95', 'food.jpg'),
(2, 'pizza', 'ONION,salt,cheese', 'my own pizza with extra chesse crust.', 'iamamarjit95', 'food.jpg'),
(3, 'pasta', 'ONION,salt,cheese,oil,butter,sauce', 'vghsdgchliosdkchv hleiqoj;k/;', 'kiran7', 'food.jpg'),
(4, 'burgur', 'ONION,salt,cheese', 'asdewqewq', 'kiran7', 'food.jpg'),
(5, 'pizza chesse', 'ONION,salt,cheese,oil,butter,butter,sauce', 'idk', 'kiran7', 'food.jpg'),
(6, 'demo', 'butter,butter,sauce', 'fmalfmlamflam', 'abc', 'food.jpg'),
(7, 'demooooo', 'salt,cheese,oil', 'hchkafjalfk', 'kaur', 'food.jpg');
...
CREATE TABLE `comments` (
   ...
   `commentContent` VARCHAR(25000) NOT NULL ) ENGINE = InnoDB;
ALTER TABLE `comments` ADD CONSTRAINT `recipeID` FOREIGN KEY (`recipeID`) REFERENCES `recepie`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
